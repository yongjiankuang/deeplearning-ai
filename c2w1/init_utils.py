# -*- coding: utf-8 -*-
"""
Created on Tue Oct  2 13:29:03 2018
...
def forward_propagation(X,parameters):
    ...
    arguments:
        ...
        parameters -- parameters "W1", "b1","W2","b2","W3","b3"
...
def backward_propagation(X,Y,cache):
    ...
    arguments:
        X -- input dataset, shape(input_size,number of examples)
        Y -- true label vector
...
def predict_dec(parameters,X):
    """
    used for plot decision boundary
